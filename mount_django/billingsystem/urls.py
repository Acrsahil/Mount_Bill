...
urlpatterns = [
    ...
    path("instock-product/", views.instock_product, name="instock_product"),
    path("lowOutstock-product/", views.lowOutstock_product, name="lowOutstock_product"),
    path("filter-category/<int:id>/", views.filter_category, name="filter_category"),
